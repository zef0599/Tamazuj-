...
class SelectConsaltantVC: UIViewController {
...
extension SelectConsaltantVC: UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
